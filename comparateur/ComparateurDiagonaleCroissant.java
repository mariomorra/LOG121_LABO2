...
Nom du fichier :	ComparateurDiagonaleCroissant.java
...
public class ComparateurDiagonaleCroissant extends AbstractComparateurForme {
	...
	public int compare(final AbstractForme forme1, final AbstractForme forme2) {
		...
		if(forme1.obtenirDiagonale() < forme2.obtenirDiagonale()) {
			flag = -1;
		}
		else if (forme1.obtenirDiagonale() > forme2.obtenirDiagonale()) {
			flag = 1;
		} else {
			flag = 0;
		}
