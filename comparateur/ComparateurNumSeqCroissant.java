...
Nom du fichier :	ComparateurNumSeqCroissant.java
...
public class ComparateurNumSeqCroissant extends AbstractComparateurForme {

	private transient int flag;
	@Override
	public int compare(final AbstractForme forme1, final AbstractForme forme2) {
		if(forme1.obtenirNseq() < forme2.obtenirNseq()) {
			flag = -1;
		}
		else if(forme1.obtenirNseq() > forme2.obtenirNseq()) {
			flag = 1;
		}
		else {
			flag = 0;
