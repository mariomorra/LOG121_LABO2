...
Nom du fichier :	ComparateurHauteurCroissant.java
...
public class ComparateurHauteurCroissant extends AbstractComparateurForme {

	private transient int flag;
	
	@Override
	public int compare(final AbstractForme forme1, final AbstractForme forme2) {
		if(forme1.obtenirHauteur() < forme2.obtenirHauteur()) {
			flag = -1;
		}
		else if(forme1.obtenirHauteur() > forme2.obtenirHauteur()) {
			flag = 1;
		}
		else {
			flag = 0;
